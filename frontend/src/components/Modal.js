...
export default function Modal({ showModal, setShowModal, content, footer, header }) {
    return (
        <>
            <TransitionOpacity show={showModal}>
                <>
                    <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0  mx-10 z-[100]">
                    ...
                    {/* Background */}
                    <div onClick={() => setShowModal(false)} className="opacity-50 fixed inset-0 z-40 bg-black">
